type LoginButton = React.ComponentPropsWithoutRef<"button">;

export default function LoginButton({ ...props }: LoginButton) {
  return (
    <button
      {...props}
      className="bg-slate-800 no-underline group cursor-pointer relative shadow-2xl shadow-zinc-900 rounded-full p-px text-sm font-semibold leading-6 text-white inline-block font-sans"
    >
